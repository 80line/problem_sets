...
bloor.aov = aov(data = bloor, formula = DISTANCE ~ DIRECTION)
summary(bloor.aov)
...
> Yes, I was able to reproduce the results I attempted to!

How difficult was it to reproduce your results? 

> For me, as someone who has very minimal exposure and experience with R, it was about a medium difficulty. 

What aspects made it difficult? What aspects made it easy?

> The most difficult part for me was looking up how certain functions worked; for example, understanding the format of the arguments that a certain function would take. However, using R Studios built-in Help function and looking up official documentation for the functions helped a lot. Also, the way this assignment was scaffolded, with the "FIXME" parts, made it easier for me to understand the logic and infer what information I needed to fill in.
